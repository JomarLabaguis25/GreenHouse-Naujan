<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="login" class="btn btn-primary  rounded-0 d-block d-lg-none">Login<i class="fa fa-arrow-right ms-3"></i></a> <!-- Show only on mobile -->
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/landing_naujan.jpg" alt="Image">
        ...
        <div class="container">
            <div class="row g-5 align-items-end">
                <div class="col-lg-3 col-md-5 wow fadeInUp" data-wow-delay="0.1s">
                    <img class="img-fluid rounded" data-wow-delay="0.1s" src="img/landing_naujan.jpg">
                </div>
    ...
    <!-- Facts Start -->
    <div class="container-fluid facts my-5 py-5" data-parallax="scroll" data-image-src="img/landing_naujan.jpg">
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-sm-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <span class="fs-5 fw-semi-bold text-light">Plot Completed</span>
                </div>
    ...
    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
        <div class="team-item rounded">
            <img class="img-fluid" src="team-1.png" alt="" style="width: 100%; height: 500px; object-fit: cover;">
            <div class="team-text">
                <h4 class="mb-0">Myko Piolo G. Feudo</h4>
                <p class="text-primary">Project Leader</p>
    ...
    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
        <div class="team-item rounded">
            <img class="img-fluid" src="team-2.jpeg" alt="" style="width: 100%; height: 500px; object-fit: cover;">
            <div class="team-text">
                <h4 class="mb-0">Jomar L. Mendoza</h4>
                <p class="text-primary">Backend and Frontend Developer</p>
                <div class="team-social d-flex">
    ...
    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
        <div class="team-item rounded">
            <img class="img-fluid" src="team-3.png" alt="" style="width: 100%; height: 500px; object-fit: cover;">
            <div class="team-text">
                <h4 class="mb-0">Ma. Angelie Patrice T. Fabella</h4>
                <p class="text-primary">Technical Writer</p>
                <div class="team-social d-flex">
                ...
                <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="owl-carousel testimonial-carousel">
                        <div class="testimonial-item">
                            ...
                            <span>Head of Municipal Agricultural Office - Naujan</span>
                        </div>
                        <div class="testimonial-item">
                            ...
                            <h4>Marlon Manalo</h4>
                            <span>OIC- Naujan Agricultural Center</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Add Download Button for PWA -->
    <a id="downloadApp" class="btn btn-primary py-2 px-3 rounded-0 btn-sm fixed-bottom mb-4 me-4 d-none" style="right: 0; position: fixed; display: flex; align-items: right; width: 10rem;">
        Download App<i class="fa fa-download ms-2"></i>
    </a>
    ...
    <script>
        ...
        window.addEventListener('beforeinstallprompt', (e) => {
            ...
            downloadAppBtn.classList.remove('d-none');
